        ...
        <!--[if lte IE 9]>
          ...
          <section class="mt-50 mb-50">
            <div class="requirments-section">
              ...
              if ($info['phpversion'] >= 7.4 && $info['mbstring'] == 1 && $info['bcmath'] == 1 && $info['ctype'] == 1 && $info['json'] == 1 && $info['openssl'] == 1 && $info['pdo'] == 1 && $info['tokenizer'] == 1 && $info['xml'] == 1 && $info['fileinfo'] == 1 && $info['allow_url_fopen'] == 1) { ?>
