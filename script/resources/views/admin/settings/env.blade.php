...
@section('title','System Environment')
                            ...
                            <div class="tab-content no-padding" id="myTab2Content">
                                <div class="tab-pane fade show active" id="home4" role="tabpanel" aria-labelledby="home-tab4">
                                    <div class="custom-form">
                                        ...
                                        <div class="form-group">
                                            <label for="CONTENT_EDITOR">{{ __('CONTENT_EDITOR') }}</label>
                                            <select class="custom-select mr-sm-2" id="CONTENT_EDITOR" name="CONTENT_EDITOR">
                                                <option value="true" @if(env('CONTENT_EDITOR') == true) selected="" @endif>{{ __('Enable') }}</option>
                                                <option value="false" @if(env('CONTENT_EDITOR') == false) selected="" @endif>{{ __('Disable') }}</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="tab-pane fade" id="other" role="tabpanel" aria-labelledby="profile-tab4">
                                    <div class="">
                                        ...
                                        <div class="form-group">
                                            <label for="MAP_API_KEY">{{ __('MAP_API_KEY') }}</label>
                                            <input type="text" name="MAP_API_KEY" id="MAP_API_KEY" value="{{ env("MAP_API_KEY") }}" class="form-control">
                                        </div>
                                        <div class="form-group">
